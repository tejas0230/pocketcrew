...
export default function CTA()
{
    ...
    return(
        <div className="w-full flex flex-col items-center">
            <PocketCrewContainer>
                <div className="w-full flex flex-col items-center py-[40px] bg-white">
                    <div className="text-[14px] text-white px-[16px] py-[8px] rounded-3xl mb-[16px] bg-[#1c1c1c]">See In Action</div>
                    <h1 className="font-heading text-[40px] text-[#1d1d1d] mb-[12px] ">Let’s build your AI Crew.</h1>
                    ...
                    <div className="flex gap-[32px]">
                        ...
                        <div className="w-[2px] bg-[#3c3c3c] h-[40px]"></div>
